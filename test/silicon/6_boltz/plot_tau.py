...
f2 = ['../1_qe/6_boltz/1.pw.out']
f3 = ['{0:s}.intrans'.format(name), '{0:s}.transdos'.format(name)]
f4 = ['{0:s}.intrans'.format(name), '../1_qe/3_ph/{0:s}.epa.e'.format(name)]
...
plt.note = [[[0.5, 1.02, 'center', 'bottom', title.format(header, doped, abs(numelec), int(round(T_K))), 'black', 1.0]]]
